...
/**
 * Adds the override stylesheet after the site's own, on pages whose card grids
 * need uniform image sizing. Kept as a separate file so main.css is untouched.
 */
function linkOverrides(html) {
  return replaceOnce(
    html,
    '    <link rel="stylesheet" href="css/main.css">\n',
    '    <link rel="stylesheet" href="css/main.css">\n' +
      '    <link rel="stylesheet" href="css/site-overrides.css">\n',
    'override stylesheet link'
  );
}
...
function buildIndex() {
  ...
  // -- A hardcoded Krooqi link outside any managed section -------------------
  // Not part of a repeatable block, so it stays literal markup. It pointed at
  // the old shared detail page, which now needs a project to show.
  html = replaceOnce(
    html,
    '<a href="portfolio-details.html" class="common-underline text-white">Krooqi</a>',
    '<a href="portfolio-details.html?slug=krooqi" class="common-underline text-white">Krooqi</a>',
    'hardcoded Krooqi detail link'
  );
...
function buildPortfolio() {
  let html = linkOverrides(read('portfolio.html'));
...
function buildProjectDetail() {
  let html = linkOverrides(read('portfolio-details.html'));
