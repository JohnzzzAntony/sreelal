...
const { detailDefaultsFor } = require('../app/db/detailDefaults');
...
function applyProjectDetails(portfolio, detail) {
  ...
  return portfolio.projects.map((project) => {
    ...
    // Everything else gets the same page structure, with placeholder copy to
    // replace. See app/db/detailDefaults.js for why nothing here invents a
    // claim about a real client.
    return {
      ...base,
